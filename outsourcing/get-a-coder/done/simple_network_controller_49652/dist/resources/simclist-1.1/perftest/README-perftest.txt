...
disabled.
Compile:
    gcc -O2 -I.. -o ins ins.c ../simclist.c
Use:
    time ./ins
...
density function).
Compile:
    gcc -O2 -I.. -o ext ext.c ../simclist.c
Use:
    time ./ext
...
Compile:
    ...
    gcc -O2 -I.. -o sort sort.c ../simclist.c
    # for testing with threading enabled
    gcc -DSIMCLIST_WITH_THREADS -O2 -I.. -o sort sort.c ../simclist.c
Use:
